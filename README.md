...
This repository contains all the tasks I completed during my **Android Development Internship** at Codsoft.

## Tasks Completed

### Task 1: To-Do List App
- Description: A simple to-do list application with add, delete, and mark as done features.
